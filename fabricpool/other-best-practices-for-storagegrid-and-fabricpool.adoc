...
== Bucket consistency control
For FabricPool buckets, the recommended bucket consistency control is *Read-after-new-write*, which is the default setting for a new bucket. Don't edit FabricPool buckets to use *Available* or any other consistency control.
