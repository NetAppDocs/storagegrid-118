...
Specifying https://review.docs.netapp.com/us-en/storagegrid-appliances_main/commonhardware/checking-dns-server-configuration.html[DNS server information^] allows you to use Fully Qualified Domain Name (FQDN) hostnames rather than IP addresses for email notifications and AutoSupport.
