...
There are many ways to achieve consistent network interface naming across multiple hosts; see link:configuring-host-network.html[Configuring the host network] for some examples.
