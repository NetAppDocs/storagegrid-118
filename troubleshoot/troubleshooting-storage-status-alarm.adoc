...
. As required, link:../expand/guidelines-for-adding-object-capacity.html[add storage capacity].
+
Also see link:../admin/managing-full-storage-nodes.html[Manage full Storage Nodes].
