...
* During this procedure all nodes have a storage capacity limit of 80%. Nodes that exceed this limit are excluded from
** the site imbalance value
** the following job completion conditions:
