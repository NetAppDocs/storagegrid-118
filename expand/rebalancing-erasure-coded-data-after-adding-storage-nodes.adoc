...
* *Job completion conditions*. The link:considerations-for-rebalancing-erasure-coded-data.html#what-is-ec-rebalancing[EC rebalance procedure] is considered complete when any of the following is true:
