...
* The EC rebalance procedure is considered complete when either of the following is true:

** The Site Imbalance metric reaches 0.02 (2%). This metric measures the standard deviation of per node storage consumption and total usage, and it can range from 0.5 to 0. Zero means erasure-coding data usage is completely balanced across all Storage Nodes at the site. 
