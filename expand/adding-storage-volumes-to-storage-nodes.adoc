...
NOTE: These instructions apply to software-based Storage Nodes only. See https://review.docs.netapp.com/us-en/storagegrid-appliances_main/sg6000/adding-expansion-shelf-to-deployed-sg6060.html[Add expansion shelf to deployed SG6060^] to learn how to add storage volumes to SG6060 by installing expansion shelves. Other appliance Storage Nodes can't be expanded.
