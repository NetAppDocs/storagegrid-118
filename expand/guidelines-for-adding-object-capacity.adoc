...
* To add one or two expansion shelves to an SG6060 storage appliance, go to https://review.docs.netapp.com/us-en/storagegrid-appliances_main/sg6000/adding-expansion-shelf-to-deployed-sg6060.html[Add expansion shelf to deployed SG6060^].
