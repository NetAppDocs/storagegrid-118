...
Optional otherwise.
| IPv4 netmask for this node on the Client Network. Specify this key when CLIENT_NETWORK_CONFIG = STATIC; don't specify it for other values.
...
2+| *GRID_NETWORK_MASK*
| Required if GRID_NETWORK_IP is specified and GRID_NETWORK_CONFIG = STATIC.
