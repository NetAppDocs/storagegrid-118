...
The following list defines the values for all supported keys.
...
[cols="1a,4a" option="header"]
|====
| Key and designation| Value
...
2+| ADMIN_NETWORK_GATEWAY
| Optional, although Required if `ADMIN_NETWORK_ESL` is specified.
...
2+| ADMIN_NETWORK_TARGET_TYPE
| Optional
| Interface (This is the only supported value.)

2+| ADMIN_NETWORK_TARGET_TYPE_INTERFACE_CLONE_MAC
| Best practice
| True or False
...
2+| CLIENT_NETWORK_CONFIG
| Optional
| DHCP, STATIC, or DISABLED

2+| CLIENT_NETWORK_GATEWAY
| Optional
...
2+| CLIENT_NETWORK_TARGET_TYPE
| Optional
| Interface (This is only supported value.)

2+| CLIENT_NETWORK_TARGET_TYPE_INTERFACE_CLONE_MAC
| Best practice
| True or False
...
2+| GRID_NETWORK_CONFIG
| Best practice
| STATIC or DHCP

(Defaults to STATIC if not specified.)

2+| GRID_NETWORK_GATEWAY
| Required
...
2+| GRID_NETWORK_TARGET_TYPE
| Optional
| Interface (This is the only supported value.)

2+| GRID_NETWORK_TARGET_TYPE_INTERFACE_CLONE_MAC
| Best practice
| True or False
