...
* For primary Admin Nodes hosted on a services appliance, you have replaced the appliance and have installed software. See the https://review..netapp.com/us-en/storagegrid-appliances/installconfig/index.html[installation instructions for your appliance^].
