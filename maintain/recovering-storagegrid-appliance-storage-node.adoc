...
NOTE: For hardware maintenance procedures, such as instructions for replacing a controller or reinstalling SANtricity OS, see the https://review.docs.netapp.com/us-en/storagegrid-appliances_main/[maintenance instructions for your storage appliance].