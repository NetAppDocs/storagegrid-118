...
NOTE: For hardware maintenance procedures, such as instructions for replacing a controller or reinstalling SANtricity OS, see the https://review..netapp.com/us-en/storagegrid-appliances/[maintenance instructions for your storage appliance].