...
* If you want to replace an older appliance with a newer appliance, consider https://docs.netapp.com/us-en/storagegrid-appliances/commonhardware/how-appliance-node-cloning-works.html[cloning the appliance node] instead of decommissioning the old node and adding the new node in an expansion.
