...
See https://review..netapp.com/us-en/storagegrid-appliances/commonhardware/how-appliance-node-cloning-works.html[Appliance node cloning: Overview^] for details.
