...
* If you need to perform a second maintenance procedure while Storage Nodes are being removed, you can 
link:pausing-and-resuming-decommission-process-for-storage-nodes.html[pause the decommission procedure]. You can resume the decommission after the other maintenance procedures are complete.
+
...
== Considerations for decommissioning a disconnected Storage Node
