...
. Follow the instructions for installing a new SG100 or SG1000 services appliance. See https://review..netapp.com/us-en/storagegrid-appliances/installconfig/index.html[Quick start for hardware installation^].
