...
NOTE: If you are consolidating older and smaller appliances with new models or larger capacity appliances, consider https://review.docs.netapp.com/us-en/storagegrid-appliances_main/commonhardware/how-appliance-node-cloning-works.html[cloning the appliance node^] (or use appliance node cloning and the decommission procedure if you aren't doing a one-to-one replacement).  
