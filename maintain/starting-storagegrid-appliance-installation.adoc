...
* You have completed these prerequisite tasks by following the installation instructions for your storage appliance. See https://review.docs.netapp.com/us-en/storagegrid-appliances_main/installconfig/index.html[Quick start for hardware installation^].
...
+
NOTE: If you need to access the Monitor Installation page manually, click *Monitor Installation* from the menu bar. See https://review.docs.netapp.com/us-en/storagegrid-appliances_main/installconfig/monitoring-appliance-installation.html[Monitor appliance installation^].