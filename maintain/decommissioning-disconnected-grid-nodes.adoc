...
* You understand the requirements and link:link:grid-node-decommissioning.html[considerations for decommissioning grid nodes].
...
. Unless you are decommissioning an Archive Node, attempt to bring any disconnected grid nodes back online or to recover them.
+
