...
One possible upgrade path is shown in the <<Example: Upgrade to StorageGRID 11.7 from version 11.3.0.8,example>>.
...
== Example: Upgrade to StorageGRID 11.7 from version 11.3.0.8

The following example shows the steps to upgrade from StorageGRID version 11.3.0.8 to version 11.7 in preparation for a StorageGRID 11.8 upgrade. 
