...
+
Make sure that the following previously opened link:../network/internal-grid-node-communications.html#storagegrid-internal-ports[internal ports] are available before you upgrade to StorageGRID 11.8:
+
