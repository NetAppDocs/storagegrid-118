...
+
The following link:../network/internal-grid-node-communications.html#storagegrid-internal-ports[internal ports] must be open before you upgrade to StorageGRID 11.8:
+
