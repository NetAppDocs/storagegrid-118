...
summary: 'The PUT Bucket consistency request allows you to specify the consistency control to apply to operations performed on a bucket.'
---
...
[.lead]
The PUT Bucket consistency request allows you to specify the consistency control to apply to operations performed on a bucket.
