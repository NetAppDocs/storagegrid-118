...
summary: 'The GET Bucket consistency request allows you to determine the consistency control being applied to a particular bucket.'
---
...
[.lead]
The GET Bucket consistency request allows you to determine the consistency control being applied to a particular bucket.
