...
* StorageGRID supports Simple Notification Service (SNS) or Kafka topics as destinations. Simple Queue Service (SQS) or Amazon Lambda endpoints aren't supported.
