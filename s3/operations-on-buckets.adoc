...
The ListObjects (GET Bucket) and ListObjectVersions (GET Bucket object versions) operations support StorageGRID link:consistency-controls.html[consistency controls].
...
| PutBucketPolicy
| This operation sets the policy attached to the bucket. See link:bucket-and-group-access-policies.html[Use bucket and group access policies].
