...
CAUTION: Never force the *Strong-site* consistency setting for PUT bucket compliance unless you have been directed to do so by technical support and unless you understand the potential consequences of using this level.
