...
The maximum _supported_ size for a single PUT Object operation is 5 TiB (5,497,558,138,880 bytes). However, the *S3 PUT Object size too large* alert will be triggered if you attempt to upload an object that exceeds 5 GiB.
