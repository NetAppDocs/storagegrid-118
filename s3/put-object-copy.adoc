...
NOTE: If your grid contains a fresh installation of StorageGRID 11.8, the *S3 PUT Object size too large* alert will be triggered if you attempt to upload an object that exceeds 5 GiB. If you upgraded from StorageGRID 11.6 or earlier, the alert won't be triggered in this case. However, to align with the AWS S3 standard, future releases of StorageGRID won't support uploads of objects larger than 5 GiB.
