...
* Change the default grid-wide consistency control setting for new buckets by link:../admin/using-grid-management-api.html[using the `grid-config` endpoint of the Grid Management private API]
