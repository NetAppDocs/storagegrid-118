...
+
See link:../admin/what-admin-node-is.html[What is an Admin Node?]
...
+
See link:../admin/what-storage-node-is.html[What is a Storage Node?]
...
For a list of supported versions, see the https://imt.netapp.com/matrix/#welcome[NetApp Interoperability Matrix Tool (IMT)^].
