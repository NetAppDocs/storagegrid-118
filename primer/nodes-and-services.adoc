...
---
= StorageGRID nodes and services
:icons: font
:imagesdir: ../media/
...
== Appliance and software nodes
StorageGRID nodes can be deployed on hardware appliances or as software-based nodes.
...
Software-based grid nodes can be deployed as virtual machines or within container engines on a Linux host.
