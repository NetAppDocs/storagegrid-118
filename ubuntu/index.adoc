 ...
 ** Identify and prepare the physical or virtual servers you plan to use to host your StorageGRID nodes.
...
* If you are an advanced developer of StorageGRID deployments, use the installation REST APIs to automate the installation of StorageGRID nodes.
