...
* To deploy StorageGRID appliance nodes, follow the https://review..netapp.com/us-en/storagegrid-appliances/installconfig/index.html[Quick start for hardware installation^].
