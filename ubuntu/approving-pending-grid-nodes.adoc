...
+
For additional information, see the https://review..netapp.com/us-en/storagegrid-appliances/installconfig/index.html[Quick start for hardware installation^] to locate instructions for your appliance.
...
Rebooting can take several minutes.
 ...
 .. Confirm that you can configure the appropriate networks. They should already be populated with the information you provided on the IP Configuration page of the Appliance Installer.
+
To learn how to install StorageGRID appliances, see the https://review..netapp.com/us-en/storagegrid-appliances/installconfig/index.html[Quick start for hardware installation^] to locate instructions for your appliance.
