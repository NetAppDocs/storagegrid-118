...
|The identifier of a delete marker. Audit log messages specify either UUDM or UUID, where UUDM indicates that the request was made on a delete marker, and UUID indicates an object.
