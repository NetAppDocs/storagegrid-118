...
+
image::../media/video-screenshot-alert-overview-117.png[link="https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=4506fc61-c8e9-4b86-ba00-b0b901184b38" alt="Video: Alerts overview for StorageGRID 11.8", window=_blank]
...
+
image::../media/video-screenshot-alert-create-custom-117.png[link="https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=e3a75bc1-47a2-44b9-a84d-b0b9011dc2d1" alt="Video: Using metrics to create custom alerts in StorageGRID 11.8", window=_blank]
