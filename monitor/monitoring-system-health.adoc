...
To be notified of alerts as soon as they are triggered, you can https://review..netapp.com/us-en/storagegrid-appliances/installconfig/setting-up-email-notifications-for-alerts.html[set up email notifications for alerts^] or link:using-snmp-monitoring.html[configure SNMP traps].
...
Optionally, you have watched the video: https://netapp.hosted.panopto.com/Panopto/Pages/Viewer.aspx?id=4506fc61-c8e9-4b86-ba00-b0b901184b38[Video: Alerts overview for StorageGRID 11.8^]
