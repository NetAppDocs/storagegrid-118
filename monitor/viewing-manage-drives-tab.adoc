...
For information about using the Manage drives tab, see https://review.docs.netapp.com/us-en/storagegrid-appliances_from-main-118appliance-more-manage-drives-28sep2023-lh/sg6100/manage-drives-tab.html[Use the Manage drives tab^].