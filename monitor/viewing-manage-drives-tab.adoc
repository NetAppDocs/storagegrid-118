...
For information about using the Manage drives tab, see https://docs.netapp.com/us-en/storagegrid-appliances_main-118appliance-kp-20230630/sg6100/manage-drives-tab.html[Use the Manage drives tab^].