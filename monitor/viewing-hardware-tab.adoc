...
|10
|===
See https://review..netapp.com/us-en/storagegrid-appliances/installconfig/configuring-network-links.html[Configure network links^] for more information about configuring the 10/25-GbE ports.
