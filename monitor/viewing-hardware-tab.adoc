...
|10
|===
See https://review.docs.netapp.com/us-en/storagegrid-appliances_main/installconfig/configuring-network-links.html[Configure network links^] for more information about configuring the 10/25-GbE ports.
