...
NOTE: If you have configured a proxy server to forward AutoSupport messages to NetApp, you should link:configuring-storage-proxy-settings.html[verify that the proxy server configuration settings are correct].
