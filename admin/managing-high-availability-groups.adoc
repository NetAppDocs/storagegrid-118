...
* An HA group that includes only SG100 or SG1000 appliances and VMware-based software nodes can provide highly available connections for link:../admin/manage-s3-select-for-tenant-accounts.html[S3 tenants that use S3 Select].
