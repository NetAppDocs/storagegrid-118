...
* A local application that supports receiving Simple Notification Service (Amazon SNS) or Kafka messages
...
* For SNS endpoints:
** *80*: For URIs that begin with HTTP
** *443*: For URIs that begin with HTTPS
* For Kafka endpoints, port *9092* for URIs that begin with HTTP or HTTPS
