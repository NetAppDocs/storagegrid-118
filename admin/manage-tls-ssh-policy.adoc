...
* If you select this policy, all nodes must be link:../maintain/rolling-reboot-procedure.html[rebooted in a rolling fashion] to enable the internal FIPS module. Use *Maintenance* > *Rolling reboot* to initiate and monitor reboots.
* If you disable the internal FIPS module, you might notice an impact on system performance.
