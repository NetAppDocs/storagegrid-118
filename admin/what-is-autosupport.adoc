...
Using AutoSupport can significantly speed problem determination and resolution. Technical support can also monitor the storage needs of your system and help you determine if you need to add new nodes or sites. Optionally, you can configure AutoSupport packages to be sent to one additional destination.
...
For more information about the details included in an AutoSupport package, expand the *AutoSupport package content* section:
