...
summary: 'The AutoSupport feature enables StorageGRID to send health and status packages to NetApp Support.'
---
...
[.lead]
The AutoSupport feature enables StorageGRID to send health and status packages to NetApp Support.
