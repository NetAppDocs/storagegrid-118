...
NOTE: When troubleshooting Kafka endpoint errors, verify that the URI hostname and port are correct and that the destination Kafka cluster is configured correctly and can connect to clients outside of storageGRID. 
