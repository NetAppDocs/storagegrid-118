...
In general, when troubleshooting Kafka endpoint errors, you should check the following configuration settings:

* The URI hostname and port are correct. 
* The destination Kafka cluster is configured correctly and can connect to clients outside of StorageGRID.
