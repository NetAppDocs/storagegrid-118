...
[.lead]
If you send AutoSupport packages using HTTP or HTTPS (see link:configure-autosupport-grid-manager.html[Configure AutoSupport]), you can configure a non-transparent proxy server between Admin Nodes and technical support (AutoSupport). 
