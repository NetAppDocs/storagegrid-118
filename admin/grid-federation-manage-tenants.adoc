...
* *STILL TRUE? Refer to remove-grid-federation-permission* You can't clear the *Use grid federation connection* permission when you are editing a tenant.

* *STILL TRUE?* You can't select a different grid federation connection when you are editing a tenant.
...
* *STILL TRUE?* Removing the *Use grid federation connection* permission from a tenant is a permanent action. You can't re-enable the permission for this tenant.
