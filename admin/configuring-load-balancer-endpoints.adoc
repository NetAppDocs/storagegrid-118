...
summary: 'Load balancer endpoints determine the ports and network protocols S3 and Swift clients can use when connecting to the StorageGRID load balancer on Gateway and Admin Nodes. You can also use preset endpoints to access the Grid Manager, Tenant Manager, or both.'
---
...
[.lead]
Load balancer endpoints determine the ports and network protocols S3 and Swift clients can use when connecting to the StorageGRID load balancer on Gateway and Admin Nodes. You can also use preset endpoints to access the Grid Manager, Tenant Manager, or both.
...
. Select the appropriate instructions to enter details for the type of endpoint you're creating.
...
=== Control tenant access (Client endpoint only)

.Steps

This step applies only to creating a client endpoint.
