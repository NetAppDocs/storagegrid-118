...
+
CAUTION: If you change the CA certificate, immediately link:../maintain/starting-or-restarting-service.html[restart the `mgmt-api` service] and test for a successful SSO into the Grid Manager.
