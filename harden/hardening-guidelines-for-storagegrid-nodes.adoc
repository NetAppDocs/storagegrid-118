...
* For appliances without SED, FDE, or FIPS drives, enable and configure StorageGRID software node encryption https://docs.netapp.com/us-en/storagegrid-appliances/installconfig/optional-enabling-node-encryption.html[using a Key Management Server (KMS)^].
