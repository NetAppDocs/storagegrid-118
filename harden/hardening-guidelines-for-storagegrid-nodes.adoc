...
* For appliance models containing SED, FDE, or FIPS NL-SAS drives that you manage with SANtricity System Manager, https://review.docs.netapp.com/us-en/storagegrid-appliances_main/installconfig/accessing-and-configuring-santricity-system-manager.html[enable and configure SANtricity Drive Security^].
