...
* If the storage controller in the appliance includes SED, FDE, or FIPS drives:

** If the Drive Security feature is enabled and you are using SANtricity System Manager to manage the drives, https://review.docs.netapp.com/us-en/storagegrid-appliances_main/installconfig/accessing-and-configuring-santricity-system-manager.html[use SANtricity to configure Drive Security keys^].

** If you are not using SANtricity System Manager to manage the SED drives, https://review.docs.netapp.com/us-en/storagegrid-appliances_main/installconfig/optional-enabling-node-encryption.html[enable drive encryption^].

* For appliances without FDE or FIPS drives, https://review.docs.netapp.com/us-en/storagegrid-appliances_main/installconfig/optional-enabling-node-encryption.html[enable node encryption^] using a Key Management Server (KMS).
