 ...
 * When configuring the XML, use the URN of an event notifications endpoint as the destination topic, as shown in the following example for an Amazon SNS endpoint:
+
----
