...
a| If the source bucket has S3 Object Lock enabled, CloudMirror replication is not supported because the source bucket cannot be used as the Cloud Storage Pool target.
