...
* Notifications:
+
For example, specifying a Simple Notification Service (Amazon SNS) endpoint:
+
----
arn:aws:sns:region:account-id:sns-topic-name
----
+
For a Kafka endpoint, you can specify a notification using a valid `kafka-topic-name`.
...
* Notifications:
+
For example, specifying an Amazon SNS endpoint:
+
----
