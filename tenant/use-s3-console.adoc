...
+
NOTE: Users who have the Manage objects with S3 Console permission but who don't have the Manage all buckets permission can still navigate directly to the S3 Console.
