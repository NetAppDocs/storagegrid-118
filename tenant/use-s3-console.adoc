...
+
In addition to the operations you can perform with the S3 Console menu, you can drag and drop files from your computer's file manager to S3 Console. However, you cannot upload folders.
