...
To clone new groups or retry a clone that failed:

. Select the checkbox for the groups you want to clone.
. Select *Actions* > *Clone groups*.
+
You can view the status of the clone operation from the details page of the group you're cloning.
