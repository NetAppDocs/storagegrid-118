...
|SASL/PLAIN
|Uses a username and password with plain test to authenticate connections to the destination.
|
* Username
* Password
...
|SASL/SCRAM-SHA-512
|Uses a username and password using a challenge-response protocol and SAH-512 hashing to authenticate connections to the destination.
|
* Username
* Password
--
