...
----
+
If you don't specify a port, the following default port is used:
* For SNS endpoints, port 443 is used for HTTPS URIs and port 80 is used for HTTP URIs.
* For Kafka endpoints, port 9092 is used for HTTPS and HTTP URIs
+
