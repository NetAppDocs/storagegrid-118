...
.CloudMirror replication and AWS search integration endpoints
--
For CloudMirror replication and AWS search integration endpoints, you can use the following credentials:
...
.CloudMirror replication or AWS search integration endpoints
--
Enter or upload the credentials for a CloudMirror replication or AWS search integration endpoint.
...
.Amazon SNS endpoints
--
Enter or upload the credentials for a Amazon SNS endpoint.
