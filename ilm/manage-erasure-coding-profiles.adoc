...
summary: 'You can view the details for an erasure-coding profile and rename a profile if needed. You can deactivate an erasure-coding profile if it isn\'\t currently used in any ILM rules.'
---
