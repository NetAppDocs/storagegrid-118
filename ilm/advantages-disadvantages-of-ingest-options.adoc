...
NOTE: Before selecting a consistency control, link:../s3/consistency-controls.html[read the full description of consistency controls]. You should understand the benefits and limitations before changing the default value.
