...
* Multiple policies (StorageGRID 11.8) assigned to tags that tenants can apply to buckets.

image::../media/ilm-policies-tags-conceptual-without-buckets.png[Multiple ILM policies diagram]
