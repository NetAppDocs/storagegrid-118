...
//need to work with Markus, Kiyomi, and Ben to determine the best way to explain and draw these concepts
...
The second diagram illustrates how tenants can easily apply different tags to each bucket, and how a grid administrator can assign a different policy to a tag.
