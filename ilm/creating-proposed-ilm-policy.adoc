...
summary: 'You can create a proposed ILM policy from scratch, or you can clone an active policy if you want to start with the same set of rules.'
---
...
[.lead]
You can create a proposed ILM policy from scratch, or you can clone an active policy if you want to start with the same set of rules.
