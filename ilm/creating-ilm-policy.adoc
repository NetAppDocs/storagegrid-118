...
.Activate one policy
--
Follow these steps if you will have only one active policy.

If you already have one or more active policies and you are activating more policies, follow the steps for activating multiple policies.
