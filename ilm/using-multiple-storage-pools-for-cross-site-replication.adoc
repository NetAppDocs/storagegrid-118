...
CAUTION: When configuring your StorageGRID deployment for site-loss protection, you must also take into account the effects of link:data-protection-options-for-ingest.html[ingest options] and link:../s3/consistency-controls.html[consistency settings].
