...
+
To remove expired object delete markers use the `ExpiredObjectDeleteMarker` action with one of the following tags: `ExpiredObjectDeleteMarker`, `Days`, or `Date`.
