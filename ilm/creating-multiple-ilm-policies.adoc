---
permalink: ilm/creating-multiple-ilm-policies.html
sidebar: sidebar
keywords: how to create multiple ILM policies
summary: 'Having multiple active ILM policies allows you to apply the appropriate ILM rules to specific tenants and buckets to fulfill multiple quality-of-service requirements.'
---
= Create multiple ILM policies
:icons: font
:imagesdir: ../media/
...
Before creating your own policies, verify that the link:creating-ilm-policy.html#default-ilm-policy[default ILM policy] does not meet your storage requirements.
