...
* link:../s3/consistency-controls.html#how-consistency-controls-and-ILM-rules-interact[How consistency settings and ILM rules interact to affect data protection]
