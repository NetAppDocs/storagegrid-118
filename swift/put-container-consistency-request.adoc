...
summary: 'The PUT container consistency request allows you to specify the consistency to apply to operations performed on a container. By default, new containers are created using the "read-after-new-write" consistency.'
---
