...
*** *Use custom password*. The password you specify in the *Custom password* field is used as the temporary installation password.
*** *Disable password*. A temporary installation password will not be used. You won't be able to access the VM to debug installation issues.
