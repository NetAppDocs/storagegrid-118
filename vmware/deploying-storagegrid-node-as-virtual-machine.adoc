...
* You have reviewed how to link:planning-and-preparation.html[plan and prepare for installation], and you understand the requirements for software, CPU and RAM, and storage and performance.
