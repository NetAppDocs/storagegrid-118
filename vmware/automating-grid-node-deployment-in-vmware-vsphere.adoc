...
* *TEMPORARY_PASSWORD_TYPE*: The temporary installation password to be used when accessing the VM console or using SSH before the node joins the grid. Can be one of the following:
