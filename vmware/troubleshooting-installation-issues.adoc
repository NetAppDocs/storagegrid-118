...
. Update *CUSTOM_TEMPORARY_PASSWORD* with the custom password value or update *TEMPORARY_PASSWORD_TYPE* with the *Use node name* value.
. Reboot the VM to apply the new password.
