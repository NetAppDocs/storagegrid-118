...
To install StorageGRID on VMware, you must install some third-party software packages. Some supported operating systems don't contain these packages by default. The software package versions that StorageGRID installations are tested on include those listed on this page. 
